...
return(
    <>
    <div className="bg-gray-200 md:grid md:grid-flow-col">
        <div className=" mt-12 pt-1 bg-white invisible md:visible  w-64 shadow-lg h-full fixed" >
...
<a href="#"><FaSearch  className="market-search absolute top-24 md:top-12  mt-3 left-4 md:text-sm "/></a> 
...
<p className= "inbox-p1 -ml-28 text-sm font-semibold ">Saved Videos</p>
        ...
        <div className=" grid grid-flow-col  col-span-2 md:invisible visible -mt-96 mt-20 ml-1">
               <div>
            ...
            <div className="grid grid-flow-col w-32 mt-1 ml-1 mb-2 visible md:invisible">
        ...
        <div className="video-pp -ml-10 md:-ml-28 lg:-ml-40 ">
        ...
        <a href="#">< BsThreeDots className="BsThreeDots ml-24 -mr-12 md:-mr-40 md:ml-60 lg:-mr-40 lg:ml-80"/></a> 
...
<div className="text-xs md:text-md -ml-1 md:ml-32">5.1K comments</div>
    ...
    <div className="download grid grid-flow-col -ml-1 md:ml-5 md:-mr-96">
        ...
        <div className="video-pp -ml-10 md:-ml-24 lg:-ml-40 ">
        ...
        <a href="#">< BsThreeDots className="BsThreeDots ml-24 -mr-12 md:-mr-36 md:ml-60 lg:-mr-40 lg:ml-80"/></a> 
