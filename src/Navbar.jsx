        ...
        <div className="lg:grid lg:grid-flow-col  md:grid md:grid-flow-col lg:w-16 flex flex-row md:grid grid-flow-col">
          <div className="lg:grid lg:grid-flow-col   md:grid grid- ">
            ...
            <input
              ...
              className="bg-slate-100 md:w-52 md:h-7 text-sm  lg:text-sm pl-7 md:-mt-7 md:pl-8 md:py-1 md:pr-1 md:mr-5 lg:ml-10 ml-12 md:ml-14 focus:outline-none lg:mt-4 lg:py-1 py-2 relative rounded-full mt-3 lg:ml-2 lg:relative"
            />
            <a href="#">
          ...
          <div className="lg:grid lg:grid-flow-col md:grid md:grid-flow-col md:mt-3 md:w-5 md:ml-10  lg:w-32 flex justify-between -ml-32 lg:ml-80 mt-24  lg:mt-4 text-slate-500  ">
            ...
            <a href="#">
              <FaFacebookMessenger className="lg:bg-slate-200 md:ml-2 md:bg-slate-200  rounded-full text-3xl  lg:text-2xl    p-1 hover:bg-slate-400 ml-6" />
            </a>
            <a href="#">
