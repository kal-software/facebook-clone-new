...
function Navbar2() {
  return (
    <>
      <div className="z-10 flex flex-row justify-between bg-white shadow-md h-14 pl-4 pr-4 md:pr-5 invisible md:visible lg:visible fixed mt-14 mb-3 lg:w-full">
        ...
        <div className="flex flex-row text-gray-500 mt-4 justify-between lg:ml-28">
          <div class="relative inline-block group">
            <i class="fa fa-home active:text-blue-500 active:bg-transparent ">
             
              <FiHome className=" md:mr-10 text-2xl lg:-ml-12 lg:mr-20 md:h-6 md:hover:bg-gray-200  lg:h-6 md:hover:w-20   lg:hover:bg-gray-200 lg:hover:w-20 md:hover:h-10 md:w-20   lg:hover:h-10 lg:w-20 h-10 lg:hover:p-2 lg:hover:-mt-2 lg:hover:rounded-md md:hover:p-2 md:hover:-mt-2 md:hover:rounded-md " />
            </i>
          ...
          <div class="relative inline-block group">
            <i class="fa fa-home">
              <MdOutlineOndemandVideo className="md:mr-5 text-2xl  lg:mr-12  lg:h-6 lg:hover:bg-gray-200 md:h-6 md:hover:bg-gray-200 lg:hover:w-20 md:hover:w-20 lg:hover:h-10 lg:hover:p-2 lg:hover:-mt-2 lg:hover:rounded-md lg:w-20 h-10 md:hover:h-10 md:w-20 md:hover:p-2 md:hover:-mt-2 md:hover:rounded-md " />
            </i>
          ...
          <div class="relative inline-block group">
            <i class="fa fa-home">
              <RiGamepadLine className="md:hover:h-10 md:w-20 md:hover:p-2 md:hover:-mt-2 md:hover:rounded-md  md:h-6 md:hover:bg-gray-200 md:hover:w-20  md:mr-6 text-2xl font-bold  lg:mr-4  lg:h-6 lg:hover:bg-gray-200 lg:hover:w-20 lg:hover:h-10 lg:hover:p-2 lg:hover:-mt-2 lg:hover:rounded-md lg:w-20 h-10" />
            </i>
          ...
          <div class="relative inline-block group">
            <i class="fa fa-home">
              <img
                src="./pic7.jpg"
                alt=""
                className="rounded-full  w-9 h-9 hover:bg-slate-200 relative"
              />
              <MdKeyboardArrowDown className="text-4xl h-5 w-5 absolute border-2 top-5 -right-1 border-white bg-gray-300 rounded-full" />
            </i>
      ...
      <div className="bg-white md:invisible lg:invisible visible -mt-14 -mr-4">
        <div className="flex flex-row ">
          <div>
            <h1 className="ml-2 text-blue-600 font-semibold text-2xl">
              facebook
            </h1>
          </div>
